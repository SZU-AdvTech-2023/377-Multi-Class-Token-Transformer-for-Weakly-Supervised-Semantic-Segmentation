...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model', default='deit_small_MCTformerV1_patch16_224', type=str, metavar='MODEL',
    ...
    # Dataset parameters
    parser.add_argument('--data-path', default='Datasets/VOC2012', type=str, help='dataset path')
    ...
    parser.add_argument('--output_dir', default='MCTformer_results/test/MCTformer_v2',
...
def main(args):
    ...
    torch.manual_seed(0) 
    np.random.seed(0)       # Convenient paper repetition
    cudnn.benchmark = True     # Reduce training time
    ...
    linear_scaled_lr = args.lr * args.batch_size * utils.get_world_size() / 512.0   # 0.0005 * 64 * 1 / 512 = 0.0000625
    args.lr = linear_scaled_lr
    optimizer = create_optimizer(args, model)
    loss_scaler = NativeScaler()  # =loss.backward() + optimizer.step()
    ...
    if args.gen_attention_maps:
        ...
        generate_attention_maps_ms(data_loader_train_, model, args.gen_attention_maps, device, args)
        return
